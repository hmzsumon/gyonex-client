...
export const authApi = {
  ...
  sendEmailOtp:  (data: object)                            => apiClient.post('/auth/send-email-change-otp', data),
...
export const adminApi = {
  ...
  // Loans
  getAllLoans:  (params?: object)                           => apiClient.get('/loans/admin/all', { params }),
...
export const dcaApi = {
  ...
  togglePlan: (id: string)    => apiClient.patch(`/trading/dca/plans/${id}/toggle`),
...
export const lotteryApi = {
  ...
  buyTickets:   (id: string, qty: number)    => apiClient.post(`/lottery/${id}/buy`, { quantity: qty }),
  getMyTickets: ()                           => apiClient.get('/lottery/my-tickets'),
  getWinners:   (page = 1)                   => apiClient.get(`/lottery/winners?page=${page}&limit=10`),
};
